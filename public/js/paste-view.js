  ...
  tabsContainer.addEventListener("click", (e) => {
    ...
    if (editor) {
      ...
      if (
        ...
        typeof window.SyntaxHighlighter.prototype.highlightElement ===
          "function"
      ) {
        const content = editor.querySelector(".paste-content");
...
function showNotification(message, type = "success") {
  ...
  if (type === "success") {
    ...
    path.setAttribute(
      "d",
      "M8 5.33333V8M8 10.6667H8.00667M14.6667 8C14.6667 11.6819 11.6819 14.6667 8 14.6667C4.3181 14.6667 1.33333 11.6819 1.33333 8C1.33333 4.3181 4.3181 1.33333 8 1.33333C11.6819 1.33333 14.6667 4.3181 14.6667 8Z"
    );
  }
